-- Business-private RLS and the organization context selector have different
-- responsibilities. A coordinator needs organization metadata to manage a
-- shared floor, but that must not grant access to menus, orders or finances.
